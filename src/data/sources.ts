...
export const SOURCES: ReadonlyArray<Source> = [
  ...
  // --- Раздел «Техническая часть» (Stage 3) ---
  {
    id: 27,
    title: 'Ракеты и люди. Фили — Подлипки — Тюратам (т. 2)',
    publisher: 'Б. Е. Черток. М.: Машиностроение, 1996; 2-е изд. 1999',
    url: 'https://testpilot.ru/espace/bibl/chertok/kniga-2/obl.html',
    category: 'memoir',
    covers:
      'Воспоминания зам. С. П. Королёва о создании Восток-3КА: компоновка СА и ПО, выбор сферической формы, отработка ТДУ; глава «Человек в космосе!».',
  },
  {
    id: 28,
    title: 'Восток (космическая программа)',
    publisher: 'Википедия (русская)',
    url: 'https://ru.wikipedia.org/wiki/Восток_(космическая_программа)',
    category: 'encyclopedia',
    covers:
      'Конструкция корабля 1К/3КА: сферический СА, конический приборный отсек, кресло-катапульта; обоснование выбора сферы.',
  },
  {
    id: 29,
    title: 'Vostok',
    publisher: 'Encyclopedia Astronautica (Mark Wade)',
    url: 'http://astronautix.com/v/vostok.html',
    category: 'encyclopedia',
    covers:
      'Кросс-чек технических параметров: высота 4.40 м, стартовая масса ~4730 кг, тяга ТДУ 15.83 кН.',
  },
  {
    id: 30,
    title: 'ТДУ-1 (тормозная двигательная установка С5.4)',
    publisher: 'Википедия (русская)',
    url: 'https://ru.wikipedia.org/wiki/ТДУ-1',
    category: 'encyclopedia',
    covers:
      'ТДУ С5.4 ОКБ-2 А. М. Исаева: ЖРД на АК20Ф/ТГ-02, импульс 266 с, время работы 45 с, одна камера + 4 верньера, разработана специально для Восток-1.',
  },
];
